...
function drawBackground() {
  g.clear();
  g.setColor(1,0,0);
  g.drawRect(0,0,screenH-1,screenW-1);
  g.setColor(0,0,0);
...
function draw(){
  ...
  g.drawString(h, 25, 70, true);
  g.drawString(("0"+m).substr(-2), 92, 70, true);
  // draw date
  g.setFontCustom(fontDate, 48, 12, 15);
  g.drawString(("0"+d).substr(-2), 123, 43, true);
